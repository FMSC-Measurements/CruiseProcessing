...
{
    public static class regionalReportHeaders
    {
        //  Region 1 reports
        //  R101 report
        public static readonly string[] R101columns = new string[10] {"  C                      ******************************************** PRIMARY PRODUCT *********************************************",
                                                      "  O",
                                                      "  N                        AVGDEF",
                                                      "  T     S       P                       GROSS      NET",
        ...
        //  R102/R103 reports
        //  BDFT OR CUFT
        public static readonly string[] R102R103columns = new string[7] {"  L  P",
                                                          "  O  R",
                                                          "  G  O",
                                                          "     D",
        ...
        //  R104 report
        public static readonly string[] R104columns = new string[2] {"           CUTTING               SAMPLE    PRIMARY     CUT/      AVG      BASAL",

                                                     " STRATA    UNIT        SPECIES   GROUP     PRODUCT     LEAVE     DBH      AREA"};
        public static readonly string[] R105sectionOne = new string[7] {"                    *************** SAWTIMBER **************   ************* NON-SAWTIMBER ****************",
        ...
        public static readonly string[] R105sectionTwo = new string[5] {" ",
        ...
        public static readonly string[] R105sectionThree = new string[5]{" ",
                                                           "T O T A L S",
                                                           "                      GROSS         NET             ************** VOLUME  ***************",
        ...
        //  Region 2 reports
        //  R201 report
        public static readonly string[] R201columns = new string[3] {"                                                                 PRIMARY PRODUCT        SECONDARY PRODUCT",
        ...
        //  R206 report
        public static readonly string[] R206columns = new string[3] {"                               NET        BDFT/CUFT",
                                                     "  CONTRACT                     CUFT       RATIO BY   QMD BY CONTRACT    AVG DBH BY",
                                                     "  SPECIES   SPECIES            VOLUME     CONTR SPP      SPECIES      CONTRACT SPECIES"};
        //  R207 report
        public static readonly string[] R207columns = new string[3] {"                             FIXED                                    TREES",
                                                     " CUTTING             # OF    PLOT                          TOTAL      PER       AVG",
                                                     " UNIT      STRATUM   PLOTS   SIZE    SPECIES    PRODUCT    STEMS      ACRE      DRC"};
 
        //  R208 report
        public static readonly string[] R208columns = new string[4] {"                                                  NET              % NET        LBS PER      WEIGHT",
        ...
        public static readonly string[] R401R402columns = new string[7] {"   S     P",
                                                         "   P     R",
                                                         "   E     O",
                                                         "   C     D                                                                                                                  NET LOG",
        ...
        //  R403/R404 reports
        //  Replace X's and Z's with BDFT (BF or MBF) or CUFT (CF or CCF) terms as needed
        public static readonly string[] R403R404columns = new string[7] {"   L    P",
                                                         "   O    R",
                                                         "   G    O",
                                                         "        D",
        ...
        //  Region 8 reports
        //  R801 report
        public static readonly string[] R801columns = new string[5] {"SALE CUT ACRES:  XXXXX",
                                                     " ",
        ...
        public static readonly string[] R801subtotal = new string[2] {"                                                                                         TOPWOOD:       ",
                                                      "                                                                        TOTAL TOPWOOD & PULPWOOD:       "};
        public static readonly string[] R801summary = new string[3] {"                                                                        ******** PER/ACRE ********",
                                                     "                        AVG      AVG     AVG     AVG      AVG UPPER     EST. #",
                                                     "                      BF/TREE  CF/TREE   DBH    SWT HT     STEM HT      OF TREES    MBF      CCF"};
        public static readonly string[] R801lines = new string[7] {"     PINE SAWTIMBER: ",
                                                   " HARDWOOD SAWTIMBER: ",
                                                   "      PINE PRODUCTS: ",
                                                   "  HARDWOOD PRODUCTS: ",
                                                   "      PINE PULPWOOD: ",
                                                   ...
                                                   "      TOTAL/AVERAGE: "};
        //  R802 report
        public static readonly string[] R802sawtimber = new string[4] {"                                  *********************  SAWTIMBER  *********************",
                                                       " ",
                                                       "                                  SAMPLE          EST. #                         TOPWOOD",
                                                       "                                  GROUP  SPECIES  OF TREES    MBF        CCF       CCF"};
        public static readonly string[] R802product08 = new string[4] {"                                  *********************  PRODUCT 8  *********************",
                                                       " ",
                                                       "                                  SAMPLE          EST. #                TOPWOOD",
                                                       "                                  GROUP  SPECIES  OF TREES      CCF       CCF"};
        public static readonly string[] R802pulpwood = new string[4] {"                                           ************  PULPWOOD  ************",
                                                      " ",
                                                      "                                           SAMPLE             EST. #",
        ...
        public static readonly string[] R001R002columns = new string[5] {"           SALE VOLUMES    (XXX)    BY SPECIES",
                                                         "      ---------------------------------------------",
                                                         "                   GROSS         NET    ",
                                                         "                   Sawlog        Sawlog ",
        ...
        public static readonly string R10specialLine = "      ----------   ------------  ------------";
        public static readonly string[] R001R002parTwo = new string[12]{"                       LOGGING CHARACTERISTICS",
                                                        "     --------------------------------------------------------------------",
        ...
        public static readonly string[] R005columns = new string[7] {"  L    S    P",
                                                     "  O    P    R",
                                                     "  G    E    O",
                                                     "       C    D",
        ...
        public static readonly string[] R006R007columns = new string[5] {"NET TTTTT FOOT VOLUME (ZZZ) BY DIAMETER GROUP FOR:  XXXXXX",
                                                         " ",
