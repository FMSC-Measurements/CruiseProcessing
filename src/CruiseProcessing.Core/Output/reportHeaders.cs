...
namespace CruiseProcessing
{
    public static class reportHeaders
    {
        ...
        public static readonly string[] VolEqHeaders = new string[5] {"                                                               PRIMARY                     SECONDARY",
                                                      "                                                       ******* PRODUCT ********      ****** PRODUCT ******",
                                                      "                                            TOTAL       MIN                             MIN",
                                                      "                     VOLUME       STUMP     CUBIC       TOP                             TOP",
                                                      "     SPECIES  PROD   EQUATION     HEIGHT    VOLUME      DIB   BDFT  CUFT  CORDS         DIB   BDFT  CUFT  CORDS   BIOMASS"};
        public static readonly string[] ValEqHeaders = new string[2] {"         PRODUCT         VALUE",
                                                      " SPECIES  CODE   GRADE  EQUATION   COEFFICIENT 1   COEFFICIENT 2   COEFFICIENT 3   COEFFICIENT 4   COEFFICIENT 5   COEFFICIENT 6"};
        public static readonly string[] BiomassHeaders = new string[2] {"                                                              FIA    WEIGHT FACTOR",
                                                        " SPECIES PROD  COMPONENT           EQU  % MOIST  % REMV  L/D  CODE   PRIM     SECD     METDATA"};
        public static readonly string[] QualityEqHeaders = new string[1] {"   SPECIES  EQUATION  YEAR(MMYYYY)   COEFFICIENT 1  COEFFICIENT 2  COEFFICIENT 3  COEFFICIENT 4  COEFFICIENT 5 COEFFICIENT 6"};


        //  A Reports
        public static readonly string[] A01unit = new string[3] {"                              CUTTING   CUTTING",
                                                "     CRUISE       CUTTING     UNIT      UNIT                        LOG      PAYMENT",
                                                "     NO.          UNIT NO.    ACRES     DESCRIPTION                 METHOD   UNIT NO."};
        public static readonly string[] A01stratum = new string[2] {"     CRUISE   STRATA   CRUISE   STRATA          PLOT  NO. OF STRATA                     DATE",
                                                   "     NO.      NO.      METHOD   ACRES   BAF     SIZE  PLOTS  DESCRIPTION                MMYYYY"};
        public static readonly string[] A02plot = new string[2] {"     CRUISE   PLOT     CUTTING  STRATA    SLOPE           PLOT   NULL",
                                                 "     NO.      NO.      UNIT NO. NO.         %     ASPECT  KPI    PLOT?"};
        public static readonly string[] A01payment = new string[2] {"     CRUISE     CUTTING             PAYMENT",
                                                    "     NO.        UNIT     STRATUM    UNIT"};
        public static readonly string[] A01samplegroup = new string[2] {"          SAMPLE                 BIG   SMALL",
                                                        " STRATUM  GROUP    FREQ   KZ     BAF   FPS      DESCRIPTION"};
        public static readonly string[] A03columns = new string[49] {"    STRATA","      UNIT","      PLOT","      TREE","   SPECIES",
                                                    ...
                                                    "    VOID %"};
        public static readonly string[] A04counts = new string[4] {"THE FOLLOWING INFORMATION IS PROVIDED FOR TREE-BASED METHODS AND REPRESENTS WHAT ONCE WERE COUNT RECORDS",
                                                  " ",
        ...
        public static readonly string[] A08columns = new string[7] {"                     /L      %   %     /L      %   %     /L      %   %     /L      %   %     /L      %   %",
        ...
        public static readonly string[] A09columns = new string[7] {"                   L                                                            %    %",
                                                   "  S                O      S     L     L                                              D",
                                                   "  T                G      M     G     E  G                                      R    E",
                                                   "  R  U    P   T                       N  R                                      E    F",
        ...
        public static readonly string[] A05A07columns = new string[10] {"                               K   Z",
                                                        "                               K   Z",
                                                        "                               K   Z",
                                                        "                  S            K   Z",
                                                        "  S               P       D    K   Z",
        ...
        public static readonly string[] A06columns = new string[10] {"                               K   Z",
                                                     "                               K   Z",
                                                     "                               K   Z",
                                                     "                  S            K   Z",
                                                     "  S               P        D   K   Z",
        ...
        public static readonly string[] A10columns = new string[10] {"                                 K   Z",
                                                     "                                 K   Z",
                                                     "                                 K   Z",
                                                     "                    S            K   Z",
                                                     "  S                 P      D     K   Z",
        ...
        public static readonly string[] A11A12columns = new string[7] {" P  S",
                                                       " R  P",
                                                       ...
                                                       " C  E",
                                                       " T  S"};
        public static readonly string[] A13plot = new string[6] {"             S",
                                                 "             T",
                                                 "    P   U    R",
                                                 "    L   N    A",
                                                 "    O   I    T",
                                                 "    T   T    A     X-METERS     Y-METERS    Z-UNIT   METADATA"};
        public static readonly string[] A13tree = new string[6] {"  S",
                                                 "  T",
                                                 "  R    U     P      T",
                                                 "  A    N     L      R",
                                                 "  T    I     O      E",
        ...
        public static readonly string[] A14columns = new string[7] {"            S    S ",
                                                  "       S    M    P",
                                                  "       T    P    E            AVG    EST        NO ",
                                                  "  U    R         C     P ",
        ...
        public static readonly string[] A15columns = new string[2] {"  VOLUME                    MIN LOG LENGTH    MAX LOG LENGTH   SEGMENTATION    MIN MERCH    EVEN/ODD",
                                                    " EQUATION   PRODUCT   TRIM     PRIMARY           PRIMARY           LOGIC        LENGTH      SEGMENT     MODIFIED?"};
        //  Summary reports right side (VSM1(B1), VSM2(CP1), VSM3(CS1))
        public static readonly string[] SummaryColumns = new string[14] {"             K     Z         ",
                                                         "             K     Z         ",
                                                         "             K     Z         ",
                                                         "             K     Z         ",
                                                         "             K     Z         ",
        ...
        public static readonly string[] StrataSummaryColumns = new string[11] {"  ",
                                                               "  ",
                                                               "  ",
                                                               "  ",
                                                               "  ",
        ...
        public static readonly string[] ValueWeightColumns = new string[11] {"  ",
                                                             "  ",
                                                             "  ",
                                                             "  ",
                                                             "  ",
        ...
        public static readonly string[] LowLevelColumns = new string[14] {"                                           ",
                                                          "                                           ",
                                                          "                                           ",
                                                          "              P                            ",
                                                          "              R                  C         ",
        ...
        public static readonly string[] VSM2columns = new string[14] {"                             ",
                                                      "                             ",
                                                      "                             ",
                                                      "       P                     ",
                                                      "       R              # OF   ",
                                                      ...
                                                      " T  C  C     R  T     E     E",
                                                      " A  T  E M   P  M     D     D"};
        public static readonly string[] VPA1VAL1columns = new string[11] {"              P                            ",
                                                          "              R                  C         ",
                                                          "              O                  O         ",
                                                          "              D        Y       T N         ",
                                                          "      S    P           L  S    R T         ",
        ...
        public static readonly string[] VPA2VAL2columns = new string[11] {"            P                             ",
                                                          "            R                             ",
                                                          "            O                             ",
                                                          "            D                             ",
                                                          "       P             S                    ",
        ...
        public static readonly string[] VSM4columns = new string[2] {"          SAMPLE   CUTTING                              GROSS    NET      EXPANSION   MEAS   TOTAL   TREE              MARKER'S",
                                                     " STRATUM  GROUP    UNIT    PLOT   TREE  SPECIES   DBH   VOLUME   VOLUME   FACTOR      KPI    KPI**   COUNT    RATIO    INITIALS"};


        //  Works for VSM5 only
        public static readonly string[] VSM5columns = new string[2] {"             CUTTING                       NUMBER     GROSS    NET      SECONDARY            BDFT/CUFT",
                                                     "             UNIT      SPECIES   PRODUCT   OF TREES   CUFT     CUFT     NET CUFT     QMD     RATIO"};
        public static readonly string[] VSM6leftSide = new string[14] {"                                         ",
                                                          "                                      ",
                                                          "                                      ",
                                                          "              P                       ",
                                                          "              R                  C    ",
                                                          ...
                                                          " A    S    T  E M  E E P  P  M D C    "};        
        //  Works for VSM6 only
        public static readonly string[] VSM6columns = new string[14] {" ",
                                                      " ",
                                                      " ",
                                                      " ",                                               
                                                      " ",
        ...
        public static readonly string[] VSM3columns = new string[14] {"                           ",
                                                      "                           ",
                                                      "                           ",
                                                      "       P                   ",
                                                      "       R         # OF      ",
        ...
        public static readonly string[] VPA3VAL3columns = new string[11] {"              P             ",
                                                          "              R             ",
                                                          "              O             ",
                                                          "              D             ",
                                                          "         P                  ",
        ...
        public static readonly string[] LiveDeadRight = new string[8] {" ",
                                                       " ",
                                                       " ",
                                                       " ",
        ...
        public static readonly string[] LD1LD2left = new string[8] {" ",
                                                    " P   S      ",
                                                    " R   P      ",
                                                    " O   E      ",
                                                    " D   C      ",
                                                    ...
                                                    " C   E      ",
                                                    " T   S      "};
        public static readonly string[] LD3LD4left = new string[8] {"C             ",
                                                    "U  P   S      ",
                                                    "T  R   P      ",
                                                    "   O   E      ",
                                                    "U  D   C      ",
                                                    ...
                                                    "I  C   E      ",
                                                    "T  T   S      "};
        public static readonly string[] LD5LD6left = new string[8] {" P             ",
                                                    " A  P   S      ",
                                                    " Y  R   P      ",
                                                    "    O   E      ",
                                                    " U  D   C      ",
                                                    ...
                                                    " I  C   E      ",
                                                    " T  T   S      "};
        public static readonly string[] LD7LD8left = new string[8] {" L             ",
                                                    " O  P   S      ",
                                                    " G  R   P      ",
                                                    "    O   E      ",
                                                    " M  D   C      ",
                                                    ...
                                                    " T  C   E      ",
                                                    " H  T   S      "};
        public static readonly string[] LiveDeadFooter = new string[3] {"NOTE:  Volumes include primary, secondary and recovered for each product number.",
        ...
        //  ST(DP) reports
        public static readonly string[] ST1ST2columns = new string[9] {"                  S",
                                                   "                  T",
        ...
        //  ST(DS) reports
        public static readonly string[] ST3columns = new string[7] {"     P         ******** ZZZZZZZZZZZZZZZZZ GROSS VOLUME **********       ******* ZZZZZZZZZZZZZZZZZ NET VOLUME ********",
                                                    "  S  R   U",
        ...
        public static readonly string[] ST4columns = new string[7] {"                                      P",
                                                   "                                  S   R    U",
                                                   "                                  T   O",
                                                   "                                  R   D    O                            **** 95% CONFIDENCE ****",
                                                   "                                  A   U    F                                    INTERVAL",
        ...
        public static readonly string[] STfooters = new string[3] {"WARNING:  PRODUCTS WITH MORE THAN ONE UNIT OF MEASURE ARE NOT CALCULATED.",
        ...
        public static readonly string[] STsubtotals = new string[3] {"                                       ------------  AGGREGATED BY PRODUCT  ------------",
                                                     "                                       --------  AGGREGATED BY UNIT OF MEASURE  --------",
                                                     "                                       ------------  AGGREGATED BY STRATA   ------------"};
        //  Export grade reports
        public static readonly string[] EX1EX2left = new string[2] {"                           LOG            LOG          LOG",
                                                    " STRATA  UNIT  PLOT  TREE  NUM  SPECIES   SORT  GRADE  LENGTH  % DEFECT"};
        public static readonly string[] EX2right = new string[2] {"                                         LOG     LOG     BDFT",
                                                  "                       SORT  GRADE       LENGTH  DIAM    VOL   DEFECT"};
        public static readonly string[] EX3columns = new string[2] {"                                                       MINIMUM    MINIMUM  MINIMUM   MAXIMUM",
                                                    "          SORT    GRADE   CODE        NAME             DIAMETER   LENGTH    BD FT    DEFECT"};
        public static readonly string[] EX4columns = new string[3] {"    LOG DIB          ****************************************  SORT & GRADE COMBINATIONS  ****************************************",
                                                    "    SMALL END",
                                                    "  1\" DIA CLASS            "};     //  sort and grade combinations are added to this line from the data
        public static readonly string[] EX6EX7right = new string[3] {"                                     EST.    ***  BDFT  ***    ***  CUFT  ***",
        ...
        public static readonly string EXfooter = "    ** LOG SORT AND/OR LOG GRADE MISSING OR INCORRECT";
        //  Log level reports
        //  L1 report
        public static readonly string[] L1columns = new string[9] {"                             U",
                                                   "                                                                %",
                                                   "                     S    P  O   L     S      L                      %",
                                                   "   S                 P    R  F   O     M      G      L          D",
                                                   "   T                 E    O      G                   E      G   E    R",
        ...
        public static readonly string[] UC1columns = new string[9] {"                               ",
                                                    "                               ",
                                                    "         S                     ",
                                                    "  S      P         U           ",
                                                    "  T      E                     ",
                                                    ...
                                                    "  T   I  E      O              ",
                                                    "  A   T  S      D  M           "};
        public static readonly string[] UC2left = new string[9] {"                               ",
                                                 "                               ",
                                                 "         S                     ",
                                                 "  S      M         U           ",
                                                 "  T      P                     ",
                                                 ...
                                                 "  T   I  R      O              ",
                                                 "  A   T  P      D  M           "};
        public static readonly string[] UC1UC2right = new string[9] {"***************************************** PRIMARY PRODUCT ******************************************",
                                                     "  AVGDEF",
                                                     "                 GROSS      NET",
                                                     " %       %                             ************************ STRATA LEVEL ***********************",
                                                     "                 BDFT       BDFT       EST.",
        ...
        public static readonly string[] UC3left = new string[7] {"          S         ",
                                                 "  S       P         ",
                                                 "  T       E         ",
                                                 "  R   U   C         ",
                                                 "  A   N   I         ",
                                                 "  T   I   E         ",
                                                 "  A   T   S         "};
        public static readonly string[] UC4left = new string[7] {"          S         ",
                                                 "  S       M         ",
                                                 "  T       P         ",
                                                 "  R   U             ",
                                                 "  A   N   G         ",
                                                 "  T   I   R         ",
                                                 "  A   T   P         "};
        public static readonly string[] UC5left = new string[7] {"      S             ",
                                                 "      P             ",
                                                 "      E             ",
                                                 "  U   C             ",
                                                 "  N   I             ",
                                                 "  I   E             ",
                                                 "  T   S             "};
        public static readonly string[] UC6left = new string[7] {"      S             ",
                                                 "      M             ",
                                                 "      P             ",
                                                 "  U                 ",
                                                 "  N   G             ",
                                                 "  I   R             ",
                                                 "  T   P             "};
        public static readonly string[] UC3TO6right = new string[7] {"TOTAL    ******************* SAWTIMBER *******************     ***************** NON-SAWTIMBER ****************",
        ...
        public static readonly string[] UC25columns = new string[2] {"                                PAYMENT            CONTRACT    SAWTIMBER     NON-SAWTIMBER",
                                                     "                                 UNIT     ACRES    SPECIES        CCF              CCF"};
        public static readonly string[] UC26columns = new string[2] {"                                CUTTING            CONTRACT    SAWTIMBER     NON-SAWTIMBER",
                                                     "                                 UNIT     ACRES    SPECIES        CCF              CCF"};
        public static readonly string[] UCfooter = new string[5] {"* FOR TREE-BASED SAMPLES, THE CUTTING UNIT VOLUME IS BASED ON THE # OF TREES TALLIED OR THE SUM OF KPIS THAT FALL WITHIN",
        ...
        //  Weight reports
        //  WT1 report
        public static readonly string[] WT1columns = new string[3] {"                                                         (1)             (2)       (3)            (4)            (5)",
        ...
        public static readonly string[] WT1footer = new string[5] {"         (1)  WEIGHT FACTOR = POUNDS PER GROSS CUFT",
        ...
        public static readonly string[] WT1total = new string[3] {"                                 SUMMARY",
                                                  "                 CONTRACT                         TONS",
                                                  "                  SPECIES        PRODUCT       REMOVED"};
        //  WT2 and WT3 reports
        //  WT2columns includes line for WT3 header -- rest is the same for WT3
        public static readonly string[] WT2columns = new string[3] {"STRATUM:  XXXX",
                                                    "SLASH LOAD            SPECIES",
                                                    "CUTTING UNIT:  XXXX"};
        public static readonly string[] WT2crown = new string[5] {"   NEEDLES |", "  0 - 1/4\" |", "  1/4 - 1\" |", "    1 - 3\" |", "       3\"+ |"};
        public static readonly string[] WT2threeplus = new string[4] {"    TOPWOOD |", "CULL VOLUME |", "     CHUNKS |", "       FLIW |"};
        //  WT4 report
        public static readonly string[] WT4columns = new string[3] {"                                           SAWTIMBER         NON-SAWTIMBER        NON-SAWTIMBER",
                                                    "  CUTTING                                  PRIM PROD = 01    OTHER PRIM PROD      SECOND PROD ONLY",
                                                    "   UNIT         ACRES       SPECIES        GREEN TONS        GREEN TONS           GREEN TONS"};
        //  WT5 report
        public static readonly string[] WT5columns = new string[4] {"    STRATUM:  XX                      GREEN TONS",
