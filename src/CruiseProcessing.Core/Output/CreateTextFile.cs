...
namespace CruiseProcessing
{
    public class CreateTextFile
    {
        ...
        private List<string> graphReports = new List<string>();
        ...
        public CreateTextFile(CPbusinessLayer dataLayer, IDialogService dialogService)
        {
        ...
        public void createTextFile()
        {
            ...
            using (StreamWriter strWriteOut = new StreamWriter(textFile))
            {
                ...
                OutputEquationTables oet = new OutputEquationTables(DataLayer, DialogService);
                ...
                OutputLiveDead old = new OutputLiveDead(DataLayer, DialogService);
                OutputLogStock ols = new OutputLogStock(DataLayer, DialogService);
                foreach (ReportsDO rdo in selectedReports)
                {
                    try
                    {
                        switch (rdo.ReportID)
                        {
                            ...
                            case "L1":
                            case "A15":
                                OutputList ol = new OutputList(DataLayer, DialogService);
                            ...
                            case "A11":
                            case "A12":
                                OutputTreeGrade otg = new OutputTreeGrade(DataLayer, DialogService);
                                otg.currRept = rdo.ReportID;
                                otg.mainHeaderFields = mainHeaderFields;
                                otg.CreateTreeGradeReports(strWriteOut, rh, ref pageNumber);
                                break;
                            case "A14":
                                OutputUnitSummary ous = new OutputUnitSummary(DataLayer, DialogService);
                            ...
                            case "ST1":
                            case "ST2":
                                OutputStats ost = new OutputStats(DataLayer, DialogService);
                                ost.currCL = "C";
                            ...
                            case "ST3":
                            case "ST4":
                                OutputStatsToo otoo = new OutputStatsToo(DataLayer, DialogService);
                            ...
                            case "UC6":
                                ...
                                break;
                            case "TIM":
                                OutputTIM ot = new OutputTIM(DataLayer, DialogService);
                            ...
                            case "TL12":
                                ...
                                OutputStandTables oStand2 = new OutputStandTables(DataLayer, DialogService);
                            ...
                            case "TL62":
                                ...
                                OutputStandTables oStand1 = new OutputStandTables(DataLayer, DialogService);
                            ...
                            case "UC26":
                                //  UC stand tables
                                OutputUnitStandTables oUnits = new OutputUnitStandTables(DataLayer, DialogService);
                            ...
                            case "WT4":
                            case "WT5":
                                OutputWeight ow = new OutputWeight(DataLayer, DialogService);
                            ...
                            case "BLM09":
                            case "BLM10":
                                OutputBLM ob = new OutputBLM(DataLayer, DialogService);
                            ...
                            case "R104":
                            case "R105":
                                OutputR1 r1 = new OutputR1(DataLayer, DialogService);
                            ...
                            case "R605":
                            case "R602":
                                OutputR6 r6 = new OutputR6(DataLayer, DialogService);
                            ...
                            case "R008":
                            case "R009":
                                OutputR10 r10 = new OutputR10(DataLayer, DialogService);
                            ...
                            case "SC2":
                            case "SC3":
                                OutputStemCounts osc = new OutputStemCounts(DataLayer, DialogService);
                            ...
                            case "LV04":
                            case "LV05":
                                OutputLeave olt = new OutputLeave(DataLayer, DialogService);
