...
namespace CruiseProcessing
{
    public class volumeLists
    {
        ...
        public static readonly VolEqList[] Region3Equations = new[] {
            ...
            new VolEqList("ALL", "Engelmann's spruce",   "300DVEW093", "Hann and Bare Equation"),
            new VolEqList("ALL", "Limber pine",          "300DVEW113", "Hann and Bare Equation"),
            new VolEqList("ALL", "Quaking aspen",        "300DVEW746", "Hann and Bare Equation"),
            ...
            new VolEqList("ALL", "Ponderosa pine",       "300DVEW122", "Eager Mill Study Equation"),
            new VolEqList("ALL", "Black maple",          "300DVEW314", "Chojnacky Equation"),
            new VolEqList("ALL", "White fir",            "301DVEW015", "Hann and Bare Equation"),
            new VolEqList("ALL", "Douglas fir",          "301DVEW202", "Hann and Bare Equation"),
            new VolEqList("1", "Ponderosa pine",         "300FW2W122", "Flewelling Profile Model"),
            new VolEqList("2", "White fir",              "302DVEW015", "Hann and Bare Equation"),
            new VolEqList("2", "Douglas fir",            "302DVEW202", "Hann and Bare Equation"),
            new VolEqList("3", "White fir",              "302DVEW015", "Hann and Bare Equation"),
            new VolEqList("3", "Douglas fir",            "302DVEW202", "Hann and Bare Equation"),
            new VolEqList("4", "Ponderosa pine",         "300FW2W122", "Flewelling Profile Model"),
            new VolEqList("7", "Douglas fir",            "302DVEW202", "Hann and Bare Equation"),
            new VolEqList("7", "White fir",              "302DVEW015", "Hann and Bare Equation"),
            new VolEqList("7", "Ponderosa pine",         "300FW2W122", "Flewelling Profile Model"),
            new VolEqList("10", "White fir",         "301FW2W015","Flewelling Profile Model"),
            new VolEqList("10", "Douglas fir",       "301FW2W202","Flewelling Profile Model"),
            new VolEqList("10", "Ponderosa Pine",    "301FW2W122","Flewelling Profile Model"),
            new VolEqList("10", "White pine",        "301FW2W108","Flewelling Profile Model"),
            new VolEqList("12", "Ponderosa pine",    "300FW2W122","Flewelling Profile Model")
        };
