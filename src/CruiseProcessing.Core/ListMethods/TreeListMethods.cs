...
namespace CruiseProcessing
{
    ...
    {
        private ErrorLogMethods elm;

        public TreeListMethods(ErrorLogMethods logErrorMethods)
        {
            elm = logErrorMethods;
        }
        ...
        public static List<TreeDO> GetCurrentStratum(List<TreeDO> tList, string currST)
        {
        ...
        public static List<string> buildPrintArray(TreeDO tdo)
        {
