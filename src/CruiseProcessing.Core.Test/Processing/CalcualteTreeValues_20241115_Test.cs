...
namespace CruiseProcessing.Test.Processing
{
    public class CalcualteTreeValues_20241115_Test : TestBase
    {
        ...
        public void ProcessTrees_Compare_CalulateTreeValues3(string fileName, CompareCalculateTreeValueFlags flags = CompareCalculateTreeValueFlags.None)
        {
            ...
            var ctv = new CalculateTreeValues_20241101(dataLayer, new VolumeLibrary_20241101(), CreateLogger<CalculateTreeValues_20241101>());
            ...
            var ctv2 = new CalculateTreeValues_20241101(dataLayer, new VolumeLibrary_20241115(), CreateLogger<CalculateTreeValues_20241101>());
